...
public class DandanatorCpcRomSetHandlerSupport {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DandanatorCpcRomSetHandlerSupport.class);
    ...
    protected static void dumpScreenTexts(OutputStream os, DandanatorCpcConfiguration configuration) throws IOException {
    ...
    public void importRomSet(InputStream stream) {
        try {
            ...
            if (slotZero.isPresent()) {
                DandanatorCpcImporter importer = slotZero.get().getImporter();
